...
echo ""
echo "── Next steps ──"
echo "   1. Install Aether:  curl -fsSL https://raw.githubusercontent.com/StratosLabs-Aether/source/main/scripts/install.sh | bash"
echo "   2. Install Ollama:  curl -fsSL https://ollama.com/install.sh | sh"
echo "   3. Install AI models:  bash install-models.sh"
echo ""
echo "   The editor, file tree, and run/debug work without AI."
echo "   Models auto-install on first Forge launch if missing."
